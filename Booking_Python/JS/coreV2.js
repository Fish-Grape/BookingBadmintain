...
function onMouseMove(arr,dragX) {
    ...
    //     window.moveX = [];
    // }
    // window.moveX.push([Math['round'](_0x53c690['dragX'] < 0 ? 0 : _0x53c690['dragX'])
    // , Math['round'](_0x53c690['clientY'] - _0x53c690['startY']), Date.now() - _0x53c690['beginTime']]);
    // console.log('moveX:' + JSON.stringify(window.moveX));
    var dragX = _0x1db195;
    var dragY = _0x5b963d;
    var dragTime = arr[2];
    var _0x5d8a62 = str_token
      , _0x177420 = _0x46a69f(_0x5d8a62, [dragX
      , dragY, dragTime] + '');
      sample_arr['push'](_0x177420)
}

function getSlideArray(dataArr){
    startX = 0; //dataArr[0][0]
    startY = 0; //dataArr[0][1]
    dragX = 0;
...
function Get_data(data){
    ...
    , str_width = parseInt(data.width, 10) / 640 * 100 + ''
...
//     'width':391,
//     'slideArr':[[4, 0, 7], [11, 0, 15], [18, 1, 23], [27, 2, 31], [35, 2, 39], [48, 2, 47], [61, 2, 55], [75, 2, 63], [91, 2, 71], [107, 2, 78], [122, 2, 87], [135, 2, 95], [147, 2, 103], [159, 2, 110], [168, 2, 119], [178, 2, 127], [183, 2, 135], [186, 2, 142], [190, 2, 151], [192, 2, 158], [194, 2, 167], [196, 2, 174], [198, 2, 183], [201, 1, 190], [203, 0, 198], [205, -1, 206], [207, -1, 214], [210, -2, 222], [212, -3, 230], [216, -4, 238], [219, -4, 247], [223, -5, 255], [228, -5, 263], [232, -5, 271], [236, -5, 279], [239, -5, 287], [241, -5, 295], [242, -5, 303], [243, -5, 327], [244, -5, 335], [245, -5, 343], [248, -4, 351], [250, -4, 358], [254, -3, 367], [257, -3, 375], [258, -3, 383], [260, -3, 390], [262, -3, 399], [263, -3, 495], [264, -3, 535], [265, -3, 543], [266, -4, 551], [267, -5, 558], [268, -5, 567], [269, -6, 791], [270, -7, 798]]
...
// if(this[_0x754334(0x3a6)].indexOf('check')){
//     return;
// }
...
// window.x_obj = {};
// }
// var x_length = window.moveX.length - 1;
// if(x_length > 0){
// var last_x = window.moveX[x_length][0];
// if(last_x > 10){
// var x_arr = window.x_obj[last_x+''];
// if(x_arr && x_arr.length){
// x_arr.push(window.moveX);
// }else{
// x_arr = [window.moveX]
// }
// window.x_obj[last_x+''] = x_arr;
// console.log(window.x_obj);
// }
// }
// window.moveX = [];			//_0x499e96
